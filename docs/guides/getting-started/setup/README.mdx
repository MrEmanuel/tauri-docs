...
Note that you shouldn't follow the below setup guide if you use `create-tauri-app`. The generated app is fully functional, but we still recommend reading one (such as the [HTML/CSS/JavaScript] guide) to understand the setup.
